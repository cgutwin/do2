...
public class MapBodyBuilder {
   ...
   * @param y               The y-coordinate of the cell in the map.
   */
  private void createRectangleBody(RectangleMapObject rectangleObject, int x, int y) {
   ...
   * @param y             The y-coordinate of the cell in the map.
   */
  private void createPolygonBody(PolygonMapObject polygonObject, int x, int y) {
    ...
    - (x*tileSize + polygon.getX()): Calculates the X-coordinate of the polygon's center, incorporating the tile's X-position and the polygon's offset.
